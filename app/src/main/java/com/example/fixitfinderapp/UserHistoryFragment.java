...
public class UserHistoryFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        MaterialButton btnTabHistory = view.findViewById(R.id.btnTabHistory);
        MaterialButton btnTabReview = view.findViewById(R.id.btnTabReview);
        applyHistoryReviewTabStyle(view, true);
        ...
        if (btnTabReview != null) {
            btnTabReview.setOnClickListener(v -> {
                if (showingHistory) {
                    applyHistoryReviewTabStyle(view, false);
                    showReviewTab();
                }
            });
        }

        recycler = view.findViewById(R.id.recyclerViewHistory);
    ...
    private void applyHistoryReviewTabStyle(View root, boolean historySelected) {
        MaterialButton btnHistory = root.findViewById(R.id.btnTabHistory);
        MaterialButton btnReview = root.findViewById(R.id.btnTabReview);
        if (btnHistory == null || btnReview == null) {
            return;
        }
        int active = ContextCompat.getColor(requireContext(), R.color.color_primary);
        int inactive = ContextCompat.getColor(requireContext(), R.color.history_tab_inactive);
